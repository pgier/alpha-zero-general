...
SMALL_BOARD_SIZE = 6
SMALL_BOARD_TOTAL_LEGAL_MOVES = SMALL_BOARD_SIZE * SMALL_BOARD_SIZE - 2 * SMALL_BOARD_SIZE
...
class TestTwixtBoard(unittest.TestCase):
    ...
    def test_twixt_links3(self):
        board = TwixtBoard(SMALL_BOARD_SIZE)
        move_1 = (2, 1)
        board.execute_move(move_1, RED)
        move_2 = (1, 2)
        self.assertTrue(move_2 not in board.get_links(move_1))
        board.execute_move(move_2, BLACK)
        move_3 = (1, 3)
        board.execute_move(move_3, RED)
        self.assertTrue(move_1 in board.get_links(move_3))
        move_4 = (3, 1)
        board.execute_move(move_4, BLACK)
        self.assertTrue(move_2 not in board.get_links(move_4))
        move_5 = (3, 2)
        board.execute_move(move_5, RED)
        self.assertTrue(move_3 in board.get_links(move_5))
        move_6 = (2, 3)
        board.execute_move(move_6, BLACK)
        print(board.get_links(move_5))
        self.assertTrue(move_4 not in board.get_links(move_6))

    def test_twixt_links4(self):
        board = TwixtBoard(SMALL_BOARD_SIZE)
        move_1 = (1, 1)
        board.execute_move(move_1, RED)
        move_2 = (1, 2)
        ...
        move_3 = (3, 2)
        board.execute_move(move_3, RED)
        self.assertTrue(move_3 in board.get_links(move_1))
        move_4 = (0, 4)
        board.execute_move(move_4, BLACK)
        self.assertTrue(move_2 in board.get_links(move_4))
